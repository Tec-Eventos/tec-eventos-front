...
class LoginAluno extends ConsumerStatefulWidget {
  /// Construtor padrão.
  const LoginAluno({super.key});

  @override
  ConsumerState<LoginAluno> createState() => _LoginAlunoState();
}

class _LoginAlunoState extends ConsumerState<LoginAluno> {
  ...
  final _controllerRmAluno = TextEditingController();
  ...
  Future<void> _handleLogin() async {
    ...
    final rm = int.tryParse(_controllerRmAluno.text.trim()) ?? 0;
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                  child: InputTextRmAluno(controllerRmAluno: _controllerRmAluno),
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                  child: InputTextPassword(controllerSenha: _controllerSenhaAluno),
                ),
              ],
            ).animate().fade(),
          ),
