...
class _SeguirState extends State<Seguir> {
  ...
  Widget build(BuildContext context) {
    return   ListTile(
      ...
      title: Text("${widget.nomeUser} começou a seguir você", style: TextStyle(
        fontFamily: Fontes.raleway,fontSize: 13)),



      subtitle: Text(widget.profissao, style: TextStyle(
        fontFamily: Fontes.raleway,fontSize: 10, fontWeight: FontWeight.bold)),
