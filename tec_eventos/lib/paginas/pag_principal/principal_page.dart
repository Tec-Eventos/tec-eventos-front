                ...
                children: [
                  ...
                  Center(
                    child: SingleChildScrollView(
                      ...
                      Row(
                        children: <Widget>[
                          FiltragemEventos(false, !competicoes, false, Icons.school_outlined, competicoes),
                          FiltragemEventos(!palestras, false, false, Icons.school_outlined, palestras),
                          FiltragemEventos(!palestras, false, false, Icons.school_outlined, palestras),
                          FiltragemEventos(!palestras, false, false, Icons.school_outlined, palestras),
                        ],
                      ),
                  ...
                  Text("Eventos que você está inscrito",
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ListTile(
                         ...
                         title: Image.network("https://kleeventos.com.br/wp-content/uploads/2019/11/AdobeStock_100250075-1030x687.jpeg"),
        ...
        child: Column(children: [
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              borderRadius: optionTrue ? BorderRadius.circular(10.0) : BorderRadius.circular(50.0),
              border: Border.all(color: optionTrue ? Colors.transparent : Cores.Azul42A5F5),
            ...
            child: Row(
              ...
              children: [
                ...
                Padding(padding: optionTrue ? EdgeInsets.symmetric(horizontal: 10) : EdgeInsets.all(0),
                  child:
                  //texto
                  Text(
                    optionTrue ? "Palestras" : "",
                    textAlign: TextAlign.center,
                    style: GoogleFonts.raleway(fontSize: 12.0, color: Cores.Branco),
                  ),
                ),
              ],
            ),
